...
import com.maurice.virolLibgdx.ui.UIVariables;
...
//    Skin skin;
	...
	public void render(float delta) {
        ...
        shapeRenderer.setColor(UIVariables.CLR_MENU_DARKBLUE);
        shapeRenderer.rect(0, 0, ZBGame.GAME_WIDTH, ZBGame.GAME_HEIGHT / 3);
        shapeRenderer.setColor(UIVariables.CLR_MENU_WHITE);
        shapeRenderer.rect(0, ZBGame.GAME_HEIGHT / 3,ZBGame.GAME_WIDTH, ZBGame.GAME_HEIGHT*2/3);
        shapeRenderer.setColor(UIVariables.CLR_MENU_LIGHTBLUE_LINE);
...
//        Table.drawDebug(stage);
	...
	public void show() {
        ...
        buttonPlaySingle.setColor(UIVariables.CLR_MENU_BUTTON);
        buttonPlaySingle.pad(30);
        buttonPlayMulti.setColor(UIVariables.CLR_MENU_BUTTON);
        buttonPlayMulti.pad(30);
        buttonAbout.setColor(UIVariables.CLR_MENU_BUTTON);
        buttonAbout.pad(30);
        buttonExit.setColor(UIVariables.CLR_MENU_BUTTON);
        buttonExit.pad(30);
...
//        table.add(title).padBottom(40).row();
        table.add(buttonPlaySingle).padBottom(20).row();
        table.add(buttonPlayMulti).padBottom(20).row();
        table.add(buttonAbout).padBottom(20).row();
        table.add(buttonExit).padBottom(20).row();
